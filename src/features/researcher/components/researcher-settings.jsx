            ...
            {[
              {
                ...
                desc: "Reminders for upcoming grant deadlines",
                on: true,
              },
              {
                name: "applications",
                label: "Application updates",
                desc: "Status changes on your grant applications",
                on: true,
              },
              {
                name: "manuscripts",
                label: "Manuscript status",
                desc: "Review decisions and revision requests",
                on: true,
              },
              {
                name: "messages",
                label: "Messages",
                desc: "New messages from collaborators and grant writers",
                on: true,
              },
              {
                name: "matches",
                label: "New matches",
                desc: "When grants or grant writers match your profile",
                on: true,
              },
              {
                name: "citations",
                label: "Citation alerts",
                desc: "When your publications are cited",
                on: true,
              },
              {
                name: "marketing",
                label: "Platform updates",
                desc: "Tips, new features, and research opportunities",
                on: false,
              },
            ].map((item) => (
              <div
          ...
          <div className="grid gap-4">
            <div className="flex items-center justify-between rounded-lg border border-destructive/20 p-4">
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Download all your research data and account info
                </p>
              </div>
