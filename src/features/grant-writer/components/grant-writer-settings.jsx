...
export function GrantWriterSettings() {
            ...
            {[
              {
                ...
                desc: "When researchers want to work with you",
                on: true,
              },
              {
                name: "projects",
                label: "Project updates",
                desc: "Deadline reminders and status changes",
                on: true,
              },
              {
                name: "messages",
                label: "Messages",
                desc: "New messages from clients and collaborators",
                on: true,
              },
              {
                name: "payments",
                label: "Payment notifications",
                desc: "When payments are received or pending",
                on: true,
              },
              {
                name: "grants",
                label: "Grant outcomes",
                desc: "When proposals you wrote are funded or declined",
                on: true,
              },
              {
                name: "directory",
                label: "New grant opportunities",
                desc: "Grants matching your expertise areas",
                on: true,
              },
              {
                name: "marketing",
                label: "Platform updates",
                desc: "Tips, features, and grant writing resources",
                on: false,
              },
            ].map((item) => (
              <div
          ...
          <div className="grid gap-4">
            <div className="flex items-center justify-between rounded-lg border border-destructive/20 p-4">
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Download all your account and project data
                </p>
              </div>
